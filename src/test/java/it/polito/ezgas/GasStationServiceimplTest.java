...
public class GasStationServiceimplTest {
	...
	public void testSaveGasStationNew() throws PriceException, GPSDataException{ 
		...
		GasStationDto gasStationDtoIn = new GasStationDto(null, "EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);	
		GasStationDto gsDtoOut=new GasStationDto(1, "EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);
		GasStation gs=new GasStation("EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);
	...
	public void testSaveGasStationNewReturnNull() throws PriceException, GPSDataException{ 
		GasStationRepository test= mock(GasStationRepository.class);
		when(test.findByGasStationAddressAndLatAndLon(anyString(), anyDouble(), anyDouble())).thenReturn(new GasStation());
	...
	public void testSaveGasStationUpdate() throws PriceException, GPSDataException {
		...
		GasStationDto gasStationDtoIn = new GasStationDto(1, "EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);	
		//GasStation nel db con stesso Id
		GasStation gasStation = new GasStation("EnerCoop", "Via Asti 47 Biella", true, true, true, true, true, "Car2Go", 45.605412, 8.0570489, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);	
		gasStation.setGasStationId(1);
		//GasStation post save
		GasStation gasStationPost = new GasStation("EnerCoop", "Via Asti 47 Biella", true, true, true, true, true, "Enjoy", 45.605412, 45.605412, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);	
	...
	public void testSaveGasStationUpdateReturnNull() throws PriceException, GPSDataException {
		...
		GasStationDto gasStationDtoIn = new GasStationDto(1, "EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);	
		//GasStation nel db con stesso Id
		GasStation gasStation = new GasStation("EnerCoop", "Via Asti 47 Biella", true, true, true, true, true, "Enjoy", 45.605412, 8.0570489, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);	
		gasStation.setGasStationId(1);
		//GasStation already found in the db with same address/&lat&lon
		GasStation gasStationFound = new GasStation("Eni", "Via Asti 47 Biella", true, false, false, true, true, "CarSharing", 45.605412, 45.605412, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/07-10:30:00", 25);	
	...
	public void testSaveGasStationInvalidLat()  {
		...
		GasStation gasStation = new GasStation("EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", -100, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);
		Integer gasStationId = 1;
		gasStation.setGasStationId(gasStationId);
		GasStationDto gasStationDto = new GasStationDto( gasStationId, "EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", -100, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);	
	...
	public void testSaveGasStationInvalidLon()  {
		...
		GasStationDto gasStationDto = new GasStationDto(1, "EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45, 200, 1.1, 1.2, 1.3, 1.4, 1.5, 5, "2020/05/17-18:30:17", 3.3);	
	...
	public void testGetGasStationByProximityRadius() throws GPSDataException {
		...
		GasStation gs1 =new GasStation("EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, null, "2020/05/17-17:30:17", 3.3);
		...
		GasStationDto gsDto1 = new GasStationDto(1,"EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, 1.1, 1.2, 1.3, 1.4, 1.5, null, "2020/05/17-18:30:17", 3.3);
		//GasStationDto gsDto2 = new GasStationDto(2, "Esso", "Viale Roma Biella", true, true, true, true, true, "Car2Go",45.5560598,8.0642756, 1.1, 1.2, 1.3, 1.4, 1.5, null, "2020/05/18-18:30:17", 3.3);
		//GasStationDto gsDto3 = new GasStationDto(3,"Eni", "Via Magenta 52 Torino", true, true, true, true, true, null, 45.0671772,7.6639721, 1.1, 1.2, 1.3, 1.4, 1.5, null, "2020/05/19-19:30:17", 3.3);
	...
	public void testGetGasStationByCarSharingNotNull() {
		...
		GasStation gs1 =new GasStation("EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, carSharing, 45.5549032, 8.0569401, -1, -1, -1, -1, -1, null, null, 0);
		gs1.setGasStationId(1);
		GasStation gs2 =new GasStation("Esso", "Via Ivrea 16 Biella", true, true, true, true, true, carSharing, 45.55,8.03, -1, -1, -1, -1, -1, null, null, 0);
		gs2.setGasStationId(2);
		gasStations.add(gs1);
		gasStations.add(gs2);
		...
		List<GasStationDto> gasStationsDto = new ArrayList<GasStationDto>();
		GasStationDto gsDto1 = new GasStationDto(1,"EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, carSharing, 45.5549032, 8.0569401, -1, -1, -1, -1, -1, null, null, 0);
		GasStationDto gsDto2 = new GasStationDto(2, "Esso", "Via Ivrea 16 Biella", true, true, true, true, true, carSharing, 45.55,8.03, -1, -1, -1, -1, -1, null, null, 0);
		gasStationsDto.add(gsDto1);
	...
	public void testGetGasStationByCarSharingNull() {
		...
		List<GasStation> gasStations = new ArrayList<GasStation>();
		//I will set ReportUser == null as to not invoke updateUserDependabilities, as I am not concerned in the outcome of that function 
		GasStation gs1 =new GasStation("EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, -1, -1, -1, -1, -1, null, null, 0);
		gs1.setGasStationId(1);
		GasStation gs2 =new GasStation("Esso", "Via Ivrea 16 Biella", true, true, true, true, true, "Car2Go", 45.55,8.03, -1, -1, -1, -1, -1, null, null, 0);
		gs2.setGasStationId(2);
		gasStations.add(gs1);
		gasStations.add(gs2);
		...
		//Create gasStationDtos List
		List<GasStationDto> gasStationsDto = new ArrayList<GasStationDto>();
		GasStationDto gsDto1 = new GasStationDto(1,"EnerCoop", "Via Macchieraldo 2 Biella", true, true, true, true, true, "Enjoy", 45.5549032, 8.0569401, -1, -1, -1, -1, -1, null, null, 0);
		GasStationDto gsDto2 = new GasStationDto(2, "Esso", "Via Ivrea 16 Biella", true, true, true, true, true, "Car2Go", 45.55,8.03, -1, -1, -1, -1, -1, null, null, 0);
		gasStationsDto.add(gsDto1);
		gasStationsDto.add(gsDto2);
	...
	public void testGetGasStationByCarSharingIsEmpty() {
		...
		//Set CarSharing type
		String carSharing= "NonExistingCarSharing";
